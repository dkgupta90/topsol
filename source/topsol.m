...
jL = 353; %65; %353;       %Photoillumination current at zero shading (in mA/cm2)
j0 = -0.0029; %-0.7158; %-0.0029;     %reverse bias current (in mA/cm2)
beta = 19.31; %8.038; %19.31;    %describes the p-n junction properties
Uref = 0.5; % 0.7;%0.68;     %fixed voltage for testing
...
sunFactor = get_sunFactor(1, nely, nelx);
