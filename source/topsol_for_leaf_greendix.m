...
penalS = 2;                     %penalty factor for shading
...
nrofe = 10001;                      %number of electrodes
...
xleaf(850:860, 200:220) = 100;
xleaf(750:800, 190:240) = 0;
...
%   end
  ...
  Eff = ((P/(Lx*Ly*area_factor))/1000)*100;
   Vbushist(loop) = Vbus;
  objhist(loop) = Eff;
